  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-20">
      ...
      {/* <div className="max-w-6xl mx-auto px-4 mb-16">
        <h3 className="text-2xl font-bold mb-6 text-center">Our Facility</h3>
        <div className="grid md:grid-cols-2 gap-4">
             <img src="/your-image-1.jpg" alt="Shop" className="w-full aspect-video object-cover rounded-xl shadow-md" />
             <img src="/your-image-2.jpg" alt="Inside" className="w-full aspect-video object-cover rounded-xl shadow-md" />
        </div>
      </div> 
      */}
